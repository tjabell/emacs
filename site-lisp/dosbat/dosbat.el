...
(defconst dosbat-version "0.0.1-cust"
...
;        '( "label " (0 font-lock-keyword-face t))
        ...
        '( "[[:space:]@]not" (0 font-lock-keyword-face t))
...
;        '( "rmdir " (0 font-lock-keyword-face t))
        ...
        '( "[[:space:]@]set" (0 font-lock-keyword-face t))
...
"
  ...
  (setq font-lock-defaults '(bat-font-lock-keywords t t))
  (turn-on-font-lock)
