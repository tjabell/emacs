...
Org ellipsis has been bugging out tangle a little bit.
   ...
   fixed by putting a -*- coding: utf-8 -*- at the top of the file
...
#+begin_src emacs-lisp
    ...
    (use-package lsp-mode
      ...
      :custom (lsp-csharp-server-path my:lsp-server))
...
* Adding hook to tangle after save
Mark this as safe for next load
#+begin_src emacs-lisp
